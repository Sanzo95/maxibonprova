...
class CodegenImplObjectStrict {
	...
	public static String genObjectUsingStrict(ClassDescriptor desc) {
		...
		/*
		 * only strict mode binding support missing/extra properties tracking 1. if
		 * null, return null 2. if empty, return empty 3. bind first field 4. while
		 * (nextToken() == ',') { bind more fields } 5. handle missing/extra properties
		 * 6. create obj with args (if ctor binding) 7. assign fields to obj (if ctor
		 * binding) 8. apply multi param wrappers
		 */
		// === if null, return null
